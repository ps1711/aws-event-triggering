...
# Version: v1
#
#This script will trigger the s3 notification and sends an email
##############
...
bucket_name="priyanshu-ultimate-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="singhpriyanshu073@gmail.com"
...
aws lambda create-function --region us-east-1 --function-name s3-lambda-function --runtime python3.8 --handler s3-lambda-function/s3-lambda-function.lambda_handler --memory-size 128 --timeout 30 --role "arn:aws:iam::558252954166:role/s3-lambda-sns" --zip-file fileb://./s3-lambda-function.zip
...
aws s3api put-bucket-notification-configuration --region us-east-1 --bucket priyanshu-ultimate-bucket --notification-configuration '{
  "LambdaFunctionConfigurations": [
    {
      "Id": "MyLambdaFunction",
      "LambdaFunctionArn": "arn:aws:lambda:us-east-1:558252954166:function:s3-lambda-function",
...
aws sns publish \
  ...
  --message "Hello from Priyanshu Singh"
